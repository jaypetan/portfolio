...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Lightweight replacement for THREE.Clock (in case Clock is deprecated).
    // Provides `start()` and `getDelta()` in seconds to match THREE.Clock API.
    class Timer {
      private _last = 0;
